document.addEventListener('DOMContentLoaded', () => {
    ...
    const types = {
        'food': '🍎 Nourriture', 'objects': '🏠 Objets', 'cleaning': '🧼 Nettoyage'
    };
    ...
    function updateStats() {
        ...
        document.getElementById('sortByNameBtn').addEventListener('click', sortItemsByName);
    ...
    function addEventListeners() {
        ...
        selectors.houseMap.addEventListener('click', (e) => {
